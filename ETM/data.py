...
def _fetch(path, name):
    if name == 'train':
        ...
        token_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_tr_tokens.mat"
        count_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_tr_counts.mat"
    elif name == 'valid':
        # token_file = os.path.join(path, 'bow_va_tokens.mat')
        # count_file = os.path.join(path, 'bow_va_counts.mat')
        token_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_va_tokens.mat"
        count_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_va_counts.mat"
    else:
        # token_file = os.path.join(path, 'bow_ts_tokens.mat')
        # count_file = os.path.join(path, 'bow_ts_counts.mat')
        token_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_ts_tokens.mat"
        count_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_ts_counts.mat"
    tokens = scipy.io.loadmat(token_file)['tokens'].squeeze()
    counts = scipy.io.loadmat(count_file)['counts'].squeeze()
    if name == 'test':
        token_1_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_ts_h1_tokens.mat"
        count_1_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_ts_h1_counts.mat"
        token_2_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_ts_h2_tokens.mat"
        count_2_file = r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\bow_ts_h2_counts.mat"
...
def get_data(path):
    with open(r"D:\Master\working\项目\ETM\ETM\ETM\data\20ng\vocab.pkl", 'rb') as f:
        vocab = pickle.load(f)
