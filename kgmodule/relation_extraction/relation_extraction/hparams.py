...
default_train_file = os.path.join(here, '../datasets/train_2.jsonl')
default_validation_file = os.path.join(here, '../datasets/val_2.jsonl')
...
parser.add_argument('--device', type=str, default='cpu')    # 可以更改gpu
